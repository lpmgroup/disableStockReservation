 ...
 *
 * ref Magento\InventoryIndexer\Model\ResourceModel\GetStockItemData
 *
 * what's changed: use cataloginventory_stock_item instead of the cataloginventory_stock_status table as the qty source
 */
declare(strict_types=1);


namespace Lpm\DisableStockReservation\Model\ResourceModel;
